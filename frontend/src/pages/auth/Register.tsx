        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold text-emerald-700">NOVA</span>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className={`w-full pl-12 pr-4 py-3 bg-gray-50 border rounded-lg focus:outline-none focus:ring-2 transition-all ${
                      formErrors.name 
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    required
                    className={`w-full pl-12 pr-12 py-3 bg-gray-50 border rounded-lg focus:outline-none focus:ring-2 transition-all ${
                      formErrors.password 
                        ? 'border-red-300 focus:border-red-500 focus:ring-red-500' 
                        : 'border-gray-200 focus:border-emerald-500 focus:ring-emerald-500'
                    } text-gray-900 placeholder-gray-500`}
